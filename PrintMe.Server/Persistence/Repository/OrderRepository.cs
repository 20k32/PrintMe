...
namespace PrintMe.Server.Persistence.Repository
{
    public sealed class OrderRepository
    {
        ...
        public IAsyncEnumerable<PrintOrder> GetOrdersByUserId(int id) => 
            ...
            .AsQueryable()
            .Where(order => order.UserId == id).ToAsyncEnumerable();
        ...
        public Task<PrintOrder> GetOrderById(int orderId) => _dbContext.PrintOrders
            .AsQueryable()
            .FirstOrDefaultAsync(existing => existing.PrintOrderId == orderId);
    }
}